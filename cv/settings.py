...
EMAIL_HOST_USER = 'marikolamine123@gmail.com'  # Adresse e-mail de l'expéditeur
EMAIL_HOST_PASSWORD = 'zkal fidp snkd plti'  # Mot de passe de votre adresse e-mail ou App Password
